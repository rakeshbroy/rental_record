    ...
    <div class="container">
        <div class="row justify-content-center align-items-center" style="height: 350px;">
            <section class="col-4 ">
                ...
                <a class="btn btn-info btn-block btn-sm" href="<?= url_for('/tenent/signup.php')  ?>">Sign Up</a>
            </section>
            <section class="col-4">
                ...
                <a class="btn btn-info btn-block btn-sm" href="<?= url_for('/landlord/signup.php')  ?>">Sign Up</a>
            </section>
        </div>
    </div>
</section>