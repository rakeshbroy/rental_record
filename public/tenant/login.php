...
<section class="container mt-3">
    <div class="row justify-content-center">
        <div class="col-md-12 col-5">
            <form id="tenantlogin" method="post" action="<?= url_for('/tenent/login.php')?>">
                    ...
                    <div class="form-group">
                        <label class="form-control-label sr-only" for="username" role="usernamelabel">Username</label>
                            <div class="input-group">
                                ...
                                <input id="username" class="form-control" type="text" name="username" placeholder="Username" value="<?= $username ?>"> 
                            </div>
                    </div>
                    <div class="form-group">
